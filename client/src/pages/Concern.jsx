  ...
  return (
    <>
      <link
        ...
        rel="stylesheet"
      />
      <div id="body" className="body-container" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", backgroundColor: "rgb(216 220 223)" }}> {/* Added a class for styling */}
